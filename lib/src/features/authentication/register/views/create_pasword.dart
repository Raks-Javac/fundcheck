  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(builder: (context) {
        ...
        final passwordNotifier = context.watch<PasswordProvider>();
        return Column(
          children: [
            addVertSpace(20),
            FWidgetsPrimaryAppBar(
            ...
            //               passwordNotifier.password1Controller,
            //           onChanged: (value) {
            //             passwordNotifier.onPasswordChange(value);
            ...
            //               padding: const EdgeInsets.all(8.0),
            //               child: GestureDetector(
            //                 onTap: () => passwordNotifier.toggleFirstPassword(),
            //                 child: Padding(
            //                   padding: const EdgeInsets.all(8.0),
            //                   child: Text(
            ...
            //           textEditingController:
            //               passwordNotifier.password2Controller,
            //           onChanged: (value) {
            //             passwordNotifier.onPasswordChange(value);
            ...
            //               child: GestureDetector(
            //                 onTap: () =>
            //                     passwordNotifier.toggleSecondPassword(),
            //                 child: Padding(
            //                   padding: const EdgeInsets.all(8.0),
            //                   child: Text(
